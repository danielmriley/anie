...
| 2026-06-13 | SWE-bench Lite n=25 (OFFICIAL grader) | gemma4:e4b | anie rlm 1/25 resolved vs mini-swe-agent 0/25; anie 5.8 turns / 37.7k tok vs 19.8 turns / 57.9k tok — won the one instance the control left empty (django-11133) | docs/external_benchmarks/results_2026-06-13.md |
| 2026-06-14 | SWE-bench Lite n=25 (OFFICIAL grader) | gemma4:12b | anie 1/25 vs control 0/25 (anie wins again); KEY FINDING: 24/25 empty patches, 0 timeouts — models terminate without editing. Bottleneck is empty-patch behavior, not budget/size. | docs/external_benchmarks/results_2026-06-13.md |
