...
| 04 — Web cancellation, budgets, and bounded side channels | 🟡 | PR A `8b09c8f` (cancellation threaded through fetch / robots / Defuddle / headless; child kill on cancel). PRs B (bounded side channels) and C/D (config + progress) still open. |
