...
| 03 — Web SSRF and redirect boundary | 🟡 | PR A landed `ea5dd9f` (manual redirect validation). PR B landed (DNS resolver abstraction + resolved-IP guard, IPv4-mapped IPv6, Class E reserved). PR C still open (headless policy). |
