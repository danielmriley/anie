//! Theme Picker overlay — placeholder.
//!
//! Tracks the future theme-selection UI from `docs/ideas.md`.
...
const TITLE: &str = "Theme Picker";
const BODY: &str = "Theme selection not yet implemented.";

/// Placeholder theme-picker screen.
pub(crate) struct ThemePickerScreen;
...
impl OverlayScreen for ThemePickerScreen {
...
mod tests {
    ...
    #[test]
    fn theme_picker_placeholder_renders_title_and_body() {
        let mut screen = ThemePickerScreen::new();
    ...
    #[test]
    fn theme_picker_placeholder_dismisses_on_any_key() {
        let mut screen = ThemePickerScreen::new();
        for key in [
    ...
    #[test]
    fn theme_picker_placeholder_tick_keeps_open() {
        let mut screen = ThemePickerScreen::new();
