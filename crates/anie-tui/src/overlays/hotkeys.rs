//! Keyboard Shortcuts overlay — placeholder.
//!
//! Tracks the future hotkeys-reference UI from `docs/ideas.md`.
...
const BODY: &str = "Hotkey reference not yet implemented. See the README for the current bindings.";

/// Placeholder keyboard-shortcuts screen.
pub(crate) struct HotkeysScreen;
...
impl OverlayScreen for HotkeysScreen {
...
mod tests {
    ...
    #[test]
    fn hotkeys_placeholder_renders_title_and_body() {
        let mut screen = HotkeysScreen::new();
    ...
    #[test]
    fn hotkeys_placeholder_dismisses_on_any_key() {
        let mut screen = HotkeysScreen::new();
        for key in [
    ...
    #[test]
    fn hotkeys_placeholder_tick_keeps_open() {
        let mut screen = HotkeysScreen::new();
