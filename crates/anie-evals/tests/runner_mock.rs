...
cat > "$metrics" <<EOF
{"schema_version":2,"harness_mode":"$mode","model":"mock","provider":"mock","wall_clock_ms":120,"turns":1,"tokens":{"input_tokens":$tot,"output_tokens":0,"cache_read_tokens":0,"cache_write_tokens":0,"total_tokens":$tot},"cost":{"input":0.0,"output":0.0,"cache_read":0.0,"cache_write":0.0,"total":0.0},"tools":{"calls":2,"failures":0,"by_tool":{"grep":{"calls":2,"failures":0}}},"compaction":{"pre_prompt":0,"mid_turn":0,"reactive_overflow":0,"total":0}}
EOF
